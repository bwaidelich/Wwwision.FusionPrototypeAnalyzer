 ...
 * @Flow\Proxy(false)
 */
final class NodeTypeName implements \Serializable
{
    ...
    private function __construct(string $value)
    {
        if (substr_count($value, ':') !== 1) {
            throw new \InvalidArgumentException(sprintf('Fully qualified NodeType name (like "Some.Package:Some.Node.Type") expected, given: "%s"', $value), 1642410973);
        }
        $this->value = $value;
    }
